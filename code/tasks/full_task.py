...
# This code was first written in 2018 and is probably not the recommended way to do things anymore.
...
from code.utils import utils, logger_utils, loss_utils
from code.models import vae_model
#import loss_utils
